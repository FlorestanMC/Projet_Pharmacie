...
const emit = defineEmits(['valider_ajouter', 'fermer']);
...
function valider_ajouter() {
    medicament._photo = photo.value
    emit('valider_ajouter', medicament)
}
...
<template>
    <div v-if="ModAjOn" class="modale-container">
        <div class="modale">
            <form @submit.prevent="valider_ajouter">
